# trip-budget Specification

## Purpose

Read-only per-currency budget rollup derived from purchase amounts and attraction entry fees, displayed in the trip thread. No FX conversion — one line per currency.
