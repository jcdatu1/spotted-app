...
Finding things on Spotted: the Discover tab's search across users, published trips, and countries — live results, country drill-down, and device-local recent searches. Follows, trending, and curated discovery layer on top of this capability later.
